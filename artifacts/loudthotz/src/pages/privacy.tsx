    ...
    <div className="min-h-screen bg-[#070906]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-500 text-sm">This document was last updated on August 18, 2015</p>
        </div>

        <div className="prose prose-invert prose-sm max-w-none space-y-8 text-gray-400 leading-relaxed">

          <p>
            This Privacy Policy governs the manner in which <strong className="text-gray-200">Nigerian Poems and Writing Poetry</strong> collects,
            uses, maintains and discloses information collected from users (each, a "User") of the{" "}
            <a href="http://loudthotzpoetry.blogspot.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
              http://loudthotzpoetry.blogspot.com/
            </a>{" "}
            website ("Site").
          </p>
          ...
          <Section title="Personal Identification Information">
            <p>
              ...
              we make available on our Site. Users may be asked for, as appropriate, their email address. We will collect personal
              identification information from Users only if they voluntarily submit such information to us. Users can always refuse
          ...
          <Section title="How We Use Collected Information">
            <p>Nigerian Poems and Writing Poetry may collect and use Users' personal information for the following purposes:</p>
            <SubSection title="To run and operate our Site">
              We may need your information to display content on the Site correctly.
            </SubSection>
            <SubSection title="To personalise user experience">
            ...
            <SubSection title="To send periodic emails">
          ...
          <Section title="How We Protect Your Information">
            <p>
              ...
              unauthorised access, alteration, disclosure or destruction of your personal information, username, password,
          ...
          <Section title="Electronic Newsletters">
            <p>
          ...
          <Section title="Third Party Websites">
            <p>
              ...
              suppliers, advertisers, sponsors, licencors and other third parties. We do not control the content or links
          ...
          <Section title="Advertising">
            <p>
              ...
              cookies allow the ad server to recognise your computer each time they send you an online advertisement to
          ...
          <Section title="Google AdSense">
            <p>
              ...
              privacy policy at{" "}
              <a href="http://www.google.com/privacy_ads.html" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
          ...
          <Section title="Changes to This Privacy Policy">
            <p>
              Nigerian Poems and Writing Poetry has the discretion to update this privacy policy at any time. When we do,
              we will post a notification on the main page of our Site and revise the updated date at the bottom of this
              page. We encourage Users to frequently check this page for any changes to stay informed about how we are
          ...
          <div className="border-t border-white/5 pt-8 mt-8">
            <p className="text-xs text-gray-600">This document was last updated on August 18, 2015</p>
          </div>
        </div>
      </div>
    </div>
